...
**Description:** Airframe structures, aerodynamic analysis, and airworthiness certification including materials
...
```bash
python3 -m pytest domains/AAA/tests/test_lint_names.py -v
```

Or test the linter directly:
```bash
python3 domains/AAA/policy/lints/lint_names.py domains/AAA
```
