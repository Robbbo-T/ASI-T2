...
**Description:** Flight deck systems, passenger cabin, and cargo handling
...
```bash
python3 -m pytest domains/CCC/tests/test_lint_names.py -v
```

Or test the linter directly:
```bash
python3 domains/CCC/policy/lints/lint_names.py domains/CCC
```
