...
**Description:** Supply chain, inventory management, and blockchain traceability
...
```bash
python3 -m pytest domains/LIB/tests/test_lint_names.py -v
```

Or test the linter directly:
```bash
python3 domains/LIB/policy/lints/lint_names.py domains/LIB
```
