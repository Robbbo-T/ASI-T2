...
**Description:** Operating systems, ontologies, and office integration interfaces
...
```bash
python3 -m pytest domains/OOO/tests/test_lint_names.py -v
```

Or test the linter directly:
```bash
python3 domains/OOO/policy/lints/lint_names.py domains/OOO
```
