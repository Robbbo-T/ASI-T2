...
This directory contains Quadratic Programming optimization artifacts including problem formulations, solution runs, and validation results.
...
Where `<ALG>` for this directory is: **QP**

### Examples

```
QP-BWQ1-QOA5710-FWD-SPAR-OPT-DEV-r001.py
QP-BWQ1-QOA5710-LAYOUT-ROUTING-DS-BENCH01-r003.json
QP-BWQ1-QOA5710-STRUCTURAL-OPT-PROD-r005.ipynb
```
