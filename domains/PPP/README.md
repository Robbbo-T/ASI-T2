...
**Description:** Propulsion systems, engines, and fuel management
...
```bash
python3 -m pytest domains/PPP/tests/test_lint_names.py -v
```

Or test the linter directly:
```bash
python3 domains/PPP/policy/lints/lint_names.py domains/PPP
```
