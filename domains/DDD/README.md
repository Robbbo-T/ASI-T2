...
**Description:** Environmental control, moisture management, and drainage systems
...
```bash
python3 -m pytest domains/DDD/tests/test_lint_names.py -v
```

Or test the linter directly:
```bash
python3 domains/DDD/policy/lints/lint_names.py domains/DDD
```
