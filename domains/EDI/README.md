...
**Description:** Avionics, digital instruments, and electronic systems
...
```bash
python3 -m pytest domains/EDI/tests/test_lint_names.py -v
```

Or test the linter directly:
```bash
python3 domains/EDI/policy/lints/lint_names.py domains/EDI
```
