...
**Description:** Cryogenic systems, quantum computing integration, and hydrogen fuel systems
...
```bash
python3 -m pytest domains/CQH/tests/test_lint_names.py -v
```

Or test the linter directly:
```bash
python3 domains/CQH/policy/lints/lint_names.py domains/CQH
```
