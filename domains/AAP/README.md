...
**Description:** Ground support equipment and airport infrastructure integration
...
```bash
python3 -m pytest domains/AAP/tests/test_lint_names.py -v
```

Or test the linter directly:
```bash
python3 domains/AAP/policy/lints/lint_names.py domains/AAP
```
