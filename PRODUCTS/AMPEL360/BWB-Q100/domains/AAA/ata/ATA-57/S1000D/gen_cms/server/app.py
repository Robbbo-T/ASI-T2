...
When lists are needed, use <randomList><listItem><para>…</para></listItem>…</randomList>.
...
Write 2–4 <levelledPara> sections, with clear <title>, and use <randomList> only when helpful.
...
def generate(req: GenerateReq):
    ...
    # splice the model output into <content>…</content>
