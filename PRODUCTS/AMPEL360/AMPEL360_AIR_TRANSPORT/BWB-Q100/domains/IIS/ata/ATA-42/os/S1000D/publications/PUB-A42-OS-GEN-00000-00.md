...
![AQUA-OS platform stack overview showing hardware →...](figures/fig-01-platform-stack.png)
...
![Context diagram: aircraft systems ↔ AQUA-OS partit...](figures/fig-02-context-diagram.png)
...
![Layered architecture diagram with components: SK, ...](figures/fig-03-architecture-layers.png)
...
![Poster-style tile grid of design principles with s...](figures/fig-04-design-principles.png)
...
![Major/minor frame timeline (Gantt-like) with label...](figures/fig-05-scheduling-timeline.png)
...
![Address space schematic: kernel region, partition ...](figures/fig-06-memory-map.png)
...
![HM concept view: detectors → classifier → action s...](figures/fig-07-hm-concept.png)
...
![Side-by-side explainer: Sampling vs Queuing. Sampl...](figures/fig-08.png)
...
![I/O virtualization: physical NIC → virtual NICs pe...](figures/fig-09.png)
...
![Boot flow/state machine: COLD → INIT → SCHEDULED; ...](figures/fig-10.png)
...
![Annotated schedule example: offsets, durations, wi...](figures/fig-11.png)
...
![Sequence diagram for overrun handling: Process ove...](figures/fig-12.png)
...
![Timing chart: producer updates sampling port; cons...](figures/fig-13.png)

**Queuing Ports**

* Bounded depth; overflow policy: drop/flag with HM event.

![Queuing behavior: enqueue/dequeue over time with d...](figures/fig-14.png)
...
![Time sync topology: grandmaster → switch fabric → ...](figures/fig-15.png)
...
![AFDX mapping view: partitions → VNics → VL IDs wit...](figures/fig-16.png)

![ARINC 429 bus map: multiple receivers/transmitters...](figures/fig-17.png)
...
![HM escalation ladder: INFO → WARNING → MAJOR → FAT...](figures/fig-18.png)
...
![Config integrity chain: schema → authoring → signi...](figures/fig-19.png)
...
![Compliance matrix heatmap: rows (ARINC 653, DO-178...](figures/fig-20.png)
...
![Traceability chain: Requirements → Design → Tests ...](figures/fig-21.png)
...
![Compact acronym wall: ARINC/DO/ARP families groupe...](figures/fig-22.png)
