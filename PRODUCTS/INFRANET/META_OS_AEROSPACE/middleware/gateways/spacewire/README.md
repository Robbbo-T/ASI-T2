---
id: ASIT2-INFRANET-METAOS-MIDDLEWARE-GATEWAYS-SPACEWIRE
project: ASI-T2
artifact: SpaceWire Gateway
llc: SYSTEMS
...
SpaceWire protocol gateway for spacecraft onboard data handling and satellite communication.
