---
id: ASIT2-INFRANET-METAOS-SECURITY-OTA-UPDATEMANIFESTS
project: ASI-T2
artifact: OTA Manifests
llc: SYSTEMS
...
Over-the-air update manifests with cryptographic signatures and rollback protection.
